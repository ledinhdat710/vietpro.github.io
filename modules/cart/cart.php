        ...
        <form method="post">
            ...
            ?>
                <div class="cart-item row">
                    ...
                    <form action="" method="post">
                        <div class="modal" id="deletemodal" tabindex="-1" role="dialog">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" class="btn btn-primary">Yes , i delete it</button>
                            </div>
                    ...
                    <div class="cart-price col-lg-3 col-md-3 col-sm-12 "><b><?php echo $total_price; ?>đ</b><button type="button" class="btn btn-danger deletebtn">Xóa</button></div>
                </div>
            <?php
            }
            ?>
